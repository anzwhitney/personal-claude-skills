...
def main() -> int:
    ...
    if args.sync:
        return cmd_sync(client, args.sync, args.plan, protocol, exclude_dir, args.dry_run, check_lyrics=not args.no_lyrics_check)
    if args.finalize:
        return cmd_finalize(client, exclude_dir, args.finalize)
    return cmd_plan(client, args.plan, protocol, exclude_dir, args.dry_run, check_lyrics=not args.no_lyrics_check)
